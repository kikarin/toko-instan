...
use App\Http\Controllers\StoreFaqController;
...
Route::middleware(['auth', 'verified', 'role:admin'])->prefix('admin')->group(function () {
    ...
    Route::patch('/tickets/{id}/status', [AdminTicketController::class, 'updateStatus'])->name('admin.tickets.status');
});
...
Route::middleware(['auth', 'role:seller'])->group(function () {
    ...
    Route::get('/faqs', [StoreFaqController::class, 'index'])->name('faqs.index');
    Route::post('/faqs', [StoreFaqController::class, 'store'])->name('faqs.store');
    Route::post('/faqs/generate', [StoreFaqController::class, 'generate'])->name('faqs.generate');
    Route::delete('/faqs/{id}', [StoreFaqController::class, 'destroy'])->name('faqs.destroy');
    Route::get('/help', [HelpController::class, 'index'])->name('help.index');
    Route::get('/support', [SupportTicketController::class, 'index'])->name('support.index');
    Route::post('/support', [SupportTicketController::class, 'store'])->name('support.store');
    Route::get('/support/{id}', [SupportTicketController::class, 'show'])->name('support.show');
    Route::post('/support/{id}/replies', [SupportTicketController::class, 'reply'])->name('support.reply');
    Route::patch('/support/{id}/status', [SupportTicketController::class, 'updateStatus'])->name('support.status');
    Route::get('/store-domain', [StoreDomainController::class, 'edit'])->name('store-domain.edit');
    Route::put('/store-domain', [StoreDomainController::class, 'update'])->name('store-domain.update');
    Route::delete('/store-domain', [StoreDomainController::class, 'destroy'])->name('store-domain.destroy');
