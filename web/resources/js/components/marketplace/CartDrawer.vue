...
<template>
    <Sheet :open="isOpen" @update:open="handleOpenChange">
        <SheetContent side="right" class="flex w-[85vw] max-w-md flex-col gap-0 p-0 sm:w-full">
            ...
            <div class="flex flex-col gap-2 border-b border-(--brand)/15 bg-(--brand)/5 px-4 py-3">
                    ...
                    >
                        ...
                        <div class="flex min-w-0 flex-1 flex-col justify-between">
                            ...
                            <div class="mt-2 flex items-end justify-between">
                                <span class="font-mono text-xs font-extrabold text-(--brand)">
            ...
            <SheetFooter v-if="items.length > 0" class="flex-col gap-3 border-t border-black/8 bg-[#faf9f6] px-5 py-4">
                ...
                <div class="flex items-center gap-2 text-[10px] font-medium text-(--brand-accent)">
