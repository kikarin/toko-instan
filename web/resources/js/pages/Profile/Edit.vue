...
// Form state
const nameValue = ref(
    props.user.name || activeUser.value?.name || 'Niko Agustio',
);
...
<template>
    ...
    >
        <main
            class="mx-auto min-h-[calc(100vh-140px)] w-full max-w-[600px] bg-white shadow-xs"
        >
            <!-- ── Top Header ── -->
            <div
            ...
            <div class="flex flex-col py-6">
                ...
                <div
                    class="flex flex-col items-center justify-center gap-2 pb-6"
                >
                    <Avatar
                        :src="userAvatar"
                ...
                <div class="flex flex-col">
                    <div
                        class="flex items-center gap-1.5 bg-white px-4 py-2 sm:px-6"
                    >
                        <span class="text-sm font-extrabold text-[#1c1c22]"
                            >Info profil</span
                        >
                    ...
                    >
                        <span
                            class="w-28 shrink-0 text-xs font-semibold text-[#9090a0]"
                            >Nama</span
                        >
                        <span
                            class="flex-1 truncate text-left text-xs font-semibold text-[#1c1c22]"
                            >{{ nameValue }}</span
                        >
                ...
                <div class="flex flex-col">
                    ...
                    <!-- User ID -->
                    <div
                        class="flex items-center justify-between border-b border-black/5 px-4 py-3.5 sm:px-6"
                    >
                        <span
                            class="w-28 shrink-0 text-xs font-semibold text-[#9090a0]"
                            >User ID</span
                        >
                        <span
                            class="flex-1 text-left font-mono text-xs font-semibold text-[#1c1c22]"
                            >{{ user.userId }}</span
                        >
                        <button
                            type="button"
                    ...
                    >
                        ...
                        <div class="flex flex-1 flex-col items-start gap-1">
                            <span
                                class="text-xs font-semibold text-[#1c1c22]"
                                >{{ phoneValue }}</span
                            >
                            <span
                                class="rounded bg-[#f0f0f5] px-1.5 py-0.5 text-[9px] font-bold text-[#9090a0]"
                            >
                                Belum Diverifikasi
                            </span>
                        </div>
                    ...
                    >
                        ...
                        >
                        <span
                            class="flex-1 text-left text-xs font-semibold text-[#1c1c22]"
                            >{{ genderValue }}</span
                        >
                        <ChevronRight class="h-4 w-4 shrink-0 text-[#9090a0]" />
                    </button>
            ...
            <DialogContent class="max-w-md rounded-2xl p-5">
                ...
                <div class="flex flex-col gap-3 py-2">
                    ...
                    <template v-if="activeEditField === 'avatar'">
                        ...
                        <div class="mt-2">
                            <p
                                class="mb-2 text-xs font-semibold text-[#4a4a57]"
                            >
                                Pilih Preset Foto:
                            </p>
                            <div class="flex items-center gap-2">
                                <button
                                    ...
                                    class="h-10 w-10 cursor-pointer overflow-hidden rounded-full ring-2 transition-all"
                                    :class="
                                        tempEditValue === preset
                                            ? 'ring-[#e07c28] ring-offset-2'
                    ...
                    <template v-else-if="activeEditField === 'gender'">
                        <div class="flex gap-3 pt-1">
                            <button
                                ...
                                class="flex-1 rounded-xl border py-2.5 text-xs font-bold transition-all"
                                :class="
                                    tempEditValue === 'Pria'
